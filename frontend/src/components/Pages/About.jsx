    ...
    <div className="App-info">
      ...
      <section className="Info">
        ...
        <ol>
          ...
          <li>
            <FaCheckCircle className="icon" />
            <strong>Contact the Seller/Owner:</strong> Reach out to the property
            owner through the app to schedule a visit or get more details.
          </li>
          <li>
            <FaCheckCircle className="icon" />
            <strong>Finalize the Deal:</strong> Complete the purchase or rental
            process as per the instructions provided by the seller/owner.
          </li>
        </ol>
      </section>
        ...
        {showFAQs && (
          <ul>
            ...
            <li>
              ...
              Payment methods vary by property. Check the listing or contact the
              owner for specific payment options.
            </li>
            <li>
